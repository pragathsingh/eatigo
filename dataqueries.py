        ...
        if(data is not None):
            ...
            if(pk_valid and col_valid):
                ...
                try:
                    ...
                    conn.close()
                    query_success = True
                    return ' Query Succeded' + updatequery
                except:
                    return 'Some problem came while executing query :'+updatequery
        else:
            return 'there is no id '+pk + 'in table '+table

    if(not query_success):
        return 'There was a problem executing the query'
